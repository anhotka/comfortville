...
@Injectable()
export class LocationAccessPopupService {
    ...
    open(component: Component, id?: number | any): Promise<NgbModalRef> {
        return new Promise<NgbModalRef>((resolve, reject) => {
            ...
            if (id) {
                ...
                setTimeout(() => {
                    this.ngbModalRef = this.locationModalRef(component, new LocationAccess());
                    resolve(this.ngbModalRef);
                }, 0);
            }
        });
    ...
    locationModalRef(component: Component, location: LocationAccess): NgbModalRef {
