...
@Injectable()
export class SiteAccessPopupService {
    ...
    open(component: Component, id?: number | any): Promise<NgbModalRef> {
        return new Promise<NgbModalRef>((resolve, reject) => {
            ...
            if (id) {
                ...
                setTimeout(() => {
                    this.ngbModalRef = this.siteModalRef(component, new SiteAccess());
                    resolve(this.ngbModalRef);
                }, 0);
            }
        });
    ...
    siteModalRef(component: Component, site: SiteAccess): NgbModalRef {
